...
| `/api/jobs` | GET | O'qitish job'lari tarixi, yangisi birinchi (`limit`, default 20) |
| `/api/jobs/{job_id}` | GET | Bitta job holati — UI bosqichni shundan kuzatadi; topilmasa **404** |
