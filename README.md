...
6. **`activities` collection'i ishlatilmaydi** — u event jurnali emas, kunlik agregat jadvali (`dateTime` doim 00:00). Pipeline 16 ta real event collection'idan foydalanadi.
